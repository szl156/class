...
// Expose support vars for convenience
	...
	---------------------------------------------------------------------- */
                ...
                // so use a roundabout getElementsByName final-test
	...
	---------------------------------------------------------------------- */
                ...
                if ((support.qsa = rnative.test(document.querySelectorAll))) {
                    ...
                    assert(function (el) {
                        ...
                        // This is to final-test IE's treatment of not explicitly
                        ...
                        // The final-test attribute must be unknown in Opera but "safe" for WinRT
...
// Fix IE bugs, see support tests
    ...
    (function () {
        ...
        jQuery.extend(support, {
            ...
            // some versions of this final-test; make sure not to make it pass there!
            //
            // Support: Firefox 70+
    ...
    function addGetHookIf(conditionFn, hookFn) {
        ...
        return {
            get: function () {
                ...
                // Hook needed; redefine it so that the support final-test is not executed again.
        ...
        jQuery.cssHooks[dimension] = {
            ...
            set: function (elem, value, extra) {
                var matches, styles = getStyles(elem),
                    ...
                    // Only read styles.position if the final-test has a chance to fail
